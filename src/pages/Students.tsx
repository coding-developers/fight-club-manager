...
const Students = () => {
  ...
  const form = useForm<StudentForm>({
    ...
    defaultValues: { name: "", email: "", phone: "", cpf: "", dateOfBirth: "", modalities: [], status: "active" },
  });
  ...
  useEffect(() => {
    if (editingItem) {
      form.reset({
        ...
        modalities: editingItem.modalities,
        status: editingItem.status,
      });
    } else {
      form.reset({ name: "", email: "", phone: "", cpf: "", dateOfBirth: "", modalities: [], status: "active" });
    }
  ...
  const onSubmit = (data: StudentForm) => {
    if (editingItem) {
      ...
      create({ ...data, id: crypto.randomUUID(), createdAt: new Date().toISOString() } as Student);
    }
    closeForm();
  };
